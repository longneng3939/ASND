    ...
    <div className="min-h-screen">
      <section className="pt-28 pb-16 px-4">
        <div className="mx-auto max-w-6xl">
          <Reveal className="text-xs uppercase tracking-[0.2em] text-gray-400 mb-4">
            Album
          </Reveal>
          <div className="overflow-hidden">
            <Reveal animation="text-rise-blur" delay={80}>
          ...
          <div className="border-t border-gray-200 pt-10">
            {albums.length === 0 ? (
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {albums.map((album, i) => (
                  <Reveal key={`${album.artistId}-${album.title}-${i}`} delay={i * 120}>
                    <div className="group">
                      <Reveal animation="cinematic-img-reveal" delay={i * 120 + 100} className="aspect-square rounded-xl border border-white/10 p-5 flex flex-col items-center justify-center shadow-lg relative overflow-hidden">
                        ...
                        <div className="relative z-10 mt-3 sm:mt-4 text-center overflow-hidden">
                          <div className="text-rise-blur" style={{ animationDelay: `${i * 120 + 250}ms` }}>
